...
export default function BrevoNewsletter() {
  ...
  <div class="sib-form" style="text-align: center; background-color: #EFF2F7;">
    <div id="sib-form-container" class="sib-form-container">
      ...
      <div id="sib-container" class="sib-container--large sib-container--vertical" style="max-width:540px; text-align:center; background-color:rgba(255,255,255,1); border-width:1px; border-style:solid; border-color:#C0CCD9; border-radius:3px; direction:ltr">
        <form id="sib-form" method="POST" action="https://f02847cc.sibforms.com/serve/MUIFAGSZ-7BLireUoeaExuDaBALa82_wg4rxi6BChpfV3rQD6VRBgf5MtD2Pxfr9uFHcOXNdEhL94JCq94liDR_0cUI3XcuXTnlIZa5_aRRemP9Tg64-gBod13xN1n1Ho9CsGKAT-UF6KAUwKr9QXB34YWSQe6C0Zw-K8zP7eVwWYm6Tj0wZTFlFhkjgogjvUfE_TsAJcyc_cnHzeg==" data-type="subscription">
            ...
            <div class="sib-input sib-form-block">
              <div class="form__entry entry_block">
                <div class="form__label-row ">
                  <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="FIRSTNAME" data-required="*">Enter your Full NAME</label>
          ...
          <div style="padding: 8px 0;">
            <div class="sib-sms-field sib-form-block">
              <div class="form__entry entry_block">
                <div class="form__label-row ">
                  <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="SMS" data-required="*">Enter your SMS</label>
                  <div class="sib-sms-input-wrapper" style="direction:ltr">
                    <div class="sib-sms-input" data-placeholder="SMS" data-required="true" data-country-code="IN" data-value="" data-attributename="SMS">
                      <div class="entry__field">
                      ...
                      <div class="entry__field" style="width: 100%">
                        <input type="tel" class="input" id="SMS" name="SMS" autocomplete="off" placeholder="SMS" data-required="true" required />
                      </div>
                    </div>
                  </div>
                </div>
  ...
  return (
    <section className="py-16 bg-[#EFF2F7] flex justify-center">
      <div 
        ref={containerRef}
